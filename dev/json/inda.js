var eventData = [
  {
    ...
    from: "08:55:00", // start time (may expand as a scope)
    to: "18:00:00", // end time (may expand as a scope)
    defaultCity: "India", // Default timezone
    defaultTimezoneOffset: "+5.5", // in GMT
    agenda: [
      {
        name: "Main Track",
